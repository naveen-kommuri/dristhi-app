...
public class ViewPreVisitScreenActivityTest {
    ...
    ViewPreVisitScreenActivity viewPreVisitScreenActivity;
    ...
    public void setup() {
        ...
        String dummyData = "{\"isHighRisk\":\"\",\"ancNumber\":\"OA1325409058749\",\"weight\":null,\"riskObserved\":\"jaundice convulsions\",\"docPocInfo\":\"[{\\\"server_version\\\": 1453706974528, \\\"poc\\\": \\\"{\\\\\\\"investigations\\\\\\\":[\\\\\\\"laboratory-Blood Test for Human chorionic gonadotropin (hCG)\\\\\\\"],\\\\\\\"planofCareDate\\\\\\\":\\\\\\\"25-01-2015\\\\\\\",\\\\\\\"drugs\\\\\\\":[{\\\\\\\"drugName\\\\\\\":\\\\\\\"adad\\\\\\\"}],\\\\\\\"diagnosis\\\\\\\":[\\\\\\\"O01 - Hydatidiform mole\\\\\\\"],\\\\\\\"visitNumber\\\\\\\":\\\\\\\"2\\\\\\\",\\\\\\\"doctorName\\\\\\\":\\\\\\\"doc111\\\\\\\",\\\\\\\"advice\\\\\\\":\\\\\\\"kckfkf\\\\\\\",\\\\\\\"visitType\\\\\\\":\\\\\\\"ANC\\\\\\\"}\\\", \\\"pending\\\": \\\"\\\"}]\",\"visitNumber\":\"2\",\"fetalData\":\"122\",\"visitDate\":\"2016-01-15\",\"bpDiastolic\":\"61\",\"bloodGlucoseData\":\"5.3\",\"bpSystolic\":\"103\",\"temperature\":\"36.8-C\",\"pulseRate\":\"88\",\"server_version\":1453706974528,\"visitPerson\":\"lhv\",\"visit_type\":\"ANC\",\"anmPoc\":\"\",\"documentId\":\"38d7b454ed2a0f8a5b2f534ae65e580f\"}";
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.putExtra("formInfo", dummyData);
        viewPreVisitScreenActivity = Robolectric.buildActivity(ViewPreVisitScreenActivity.class).withIntent(intent).create().get();
    }

    @Test
    public void testingonCreate() {
        assertNotNull(viewPreVisitScreenActivity);
        Button bt_close = (Button) viewPreVisitScreenActivity.findViewById(R.id.bt_close);
        assertNotNull(bt_close);
