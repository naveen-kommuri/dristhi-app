...
public class ViewPlanOfCareActivityTest2 {
    ...
    public void testingancPoc() {
        ...
        when(childService.getMotherUseEntityId("entity1")).thenReturn(mother);
        when(mother.ecCaseId()).thenReturn("ec1");
        when(allEligibleCouples.findByCaseID("ec1")).thenReturn(eligibleCouple);
        ...
        ViewPlanOfCareActivity activityController = Robolectric.buildActivity(ViewPlanOfCareActivity.class).withIntent(intent).create().resume().get();
        activityController.finish();
        Robolectric.reset();
    }

//    @Test
//    public void testingChildPoc() {
//
//        String pocData = "[{\"pending\": \"\", \"poc\": \"{\\\"investigations\\\":[\\\"laboratory-Blood chemistry test\\\"],\\\"diagnosis\\\":[\\\"O08.5 - Metabolic disorders following an ectopic and molar pregnancy\\\\t\\\"],\\\"planofCareDate\\\":\\\"07-01-2016\\\",\\\"doctorName\\\":\\\"doc111\\\",\\\"advice\\\":\\\"feed well\\\",\\\"drugs\\\":[{\\\"dosage\\\":\\\"35 ml\\\",\\\"frequency\\\":\\\"Every 12 Hours\\\",\\\"drugNoOfDays\\\":\\\"5\\\",\\\"drugQty\\\":\\\"5\\\",\\\"direction\\\":\\\"before break fast\\\",\\\"drugName\\\":\\\"Protein and Fatty Acid Supplement\\\"}],\\\"visitType\\\":\\\"CHILD\\\"}\", \"server_version\": 1452174511886}, {\"pending\": \"\", \"poc\": \"{\\\"investigations\\\":[],\\\"diagnosis\\\":[\\\"A01.0 - Typhoid fever\\\"],\\\"planofCareDate\\\":\\\"08-01-2016\\\",\\\"doctorName\\\":\\\"doc111\\\",\\\"advice\\\":\\\"\\\",\\\"drugs\\\":[],\\\"visitType\\\":\\\"CHILD\\\"}\", \"server_version\": 1452241059167}, {\"pending\": \"\", \"poc\": \"{\\\"investigations\\\":[],\\\"diagnosis\\\":[\\\"O08.0 - Genital tract and pelvic infection following ectopic and molar pregnancy\\\\t\\\"],\\\"planofCareDate\\\":\\\"08-01-2016\\\",\\\"doctorName\\\":\\\"doc111\\\",\\\"advice\\\":\\\"\\\",\\\"drugs\\\":[],\\\"visitType\\\":\\\"CHILD\\\"}\", \"server_version\": 1452244693967}, {\"server_version\": 1452245206379, \"poc\": \"{\\\"investigations\\\":[],\\\"diagnosis\\\":[\\\"O07.5 - Other and unspecified failed attempted abortion, complicated by genital tract and pelvic infection\\\"],\\\"planofCareDate\\\":\\\"08-01-2016\\\",\\\"doctorName\\\":\\\"doc111\\\",\\\"advice\\\":\\\"\\\",\\\"drugs\\\":[],\\\"visitType\\\":\\\"CHILD\\\"}\", \"pending\": \"\"}]";
//        Intent intent = new Intent(Intent.ACTION_VIEW);
//        intent.putExtra(AllConstants.ENTITY_ID, "entity1");
...
//        when(context.allEligibleCouples()).thenReturn(allEligibleCouples);
//        when(context.allBeneficiaries()).thenReturn(allBeneficiaries);
//        when(allBeneficiaries.findChild("entity1")).thenReturn(child);
//        when(child.motherCaseId()).thenReturn("mothercase1");
//        when(childService.getMotherUseEntityId("mothercase1")).thenReturn(mother);
//        when(mother.ecCaseId()).thenReturn("ec1");
//        when(allEligibleCouples.findByCaseID("ec1")).thenReturn(eligibleCouple);
//        when(mother.getDetail("docPocInfo")).thenReturn(pocData);
//        when(eligibleCouple.wifeName()).thenReturn("Wife1");
//
//
//        ActivityController activityController = Robolectric.buildActivity(ViewPlanOfCareActivity.class).withIntent(intent).create().resume();
//    }
