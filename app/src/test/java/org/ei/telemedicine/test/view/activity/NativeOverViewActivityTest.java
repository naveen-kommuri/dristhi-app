...
public class NativeOverViewActivityTest {
    ...
    public void testingonCreate() {
        ...
        when(context.allTimelineEvents()).thenReturn(allTimelineEvents);
//        when(eligibleCouple.village()).thenReturn("village1");
//
//        when(eligibleCouple.subCenter()
//                when(eligibleCouple.ecNumber(),
//                        when(eligibleCouple.isHighPriority()
//                                when(eligibleCouple.photoPath(), new ArrayList<Child>(), new CoupleDetails(eligibleCouple.wifeName(),
//                                                eligibleCouple.husbandName(), eligibleCouple.ecNumber(), eligibleCouple.isOutOfArea()),
//                                        eligibleCouple.details()
        when(eligibleCoupleDetailController.get()).thenReturn("");
