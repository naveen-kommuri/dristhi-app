...
public class NativeECSmartRegisterActivityTest {
    ...
    NativeECSmartRegisterActivity nativeECSmartRegisterActivity;
    @Mock
    ...
    public void setup() {
        ...
        nativeECSmartRegisterActivity = Robolectric.buildActivity(NativeECSmartRegisterActivity.class).create().resume().destroy().get();
    }
