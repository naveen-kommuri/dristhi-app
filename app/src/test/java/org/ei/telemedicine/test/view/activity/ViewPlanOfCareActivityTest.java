...
public class ViewPlanOfCareActivityTest {
...
//        dummyData.put("docPocInfo", pocData);
//        dummyData.put("ancNumber", "anc1");
//        when(allBeneficiaries.findChild("entity1")).thenReturn(new Child("case1", "case1", "male", dummyData));
//        when(childService.getMotherUseEntityId("case1")).thenReturn(new Mother("case1", "case1", "", "00-00-0000").withDetails(dummyData));
//        when(allEligibleCouples.findByCaseID("case1")).thenReturn(new EligibleCouple("case1", "wife1", "husband1", "123", "village1", "sub1", dummyData));
//
